...
export const Signup = () => {
  ...
  return (
    ...
    <ToastContainer/>
      <h1 className="text-5xl text-center my-10 uppercase text-white font-bold">
        Create Account
      </h1>
      <div className="mx-auto w-[400px] my-10 flex flex-col gap-5">
        ...
        <button className="btn btn-active btn-primary uppercase" onClick={createAccount}>
          Sign up
        </button>
        <div className='w-full flex flex-row justify-between'>
        <p>Already have an account</p>
        <Link className='text-blue-500' to={"/"}>Log In</Link>
        {/* <a>Create Account</a> */}
      </div>
      </div>
    </div>
